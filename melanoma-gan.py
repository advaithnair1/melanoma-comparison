...
# this was the dataset that i used: https://www.kaggle.com/datasets/hasnainjaved/melanoma-skin-cancer-dataset-of-10000-images
benign_folder = "benign images here"
malignant_folder = "malignant images here"
...
print(f"Total number of images after augmentation: {len(X_train)}") # 50000 = 10000 + (4 x 10000)
...
#train GAN for 1000 epochs, 32 batch size
...
print(f"Discriminator test accuracy: {accuracy * 100}%")
